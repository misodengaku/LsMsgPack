...
namespace LsMsgPackUnitTests
{
    ...
    public class MpIntTest
    {
        ...
        [TestCase((sbyte)50, 1, MsgPackTypeId.MpBytePart)]
        [TestCase((int)128, 2, MsgPackTypeId.MpUByte)]
        [TestCase((short)129, 2, MsgPackTypeId.MpUByte)]
        [TestCase((int)129, 2, MsgPackTypeId.MpUByte)]
        [TestCase((long)129, 2, MsgPackTypeId.MpUByte)]
        [TestCase((int)1234, 3, MsgPackTypeId.MpUShort)]
        [TestCase(short.MaxValue, 3, MsgPackTypeId.MpUShort)]
        [TestCase(int.MaxValue, 5, MsgPackTypeId.MpUInt)]
        [TestCase(long.MaxValue, 9, MsgPackTypeId.MpULong)]
